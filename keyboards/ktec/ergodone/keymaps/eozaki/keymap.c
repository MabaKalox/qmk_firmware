 ...
 * |--------+------+------+------+------+------|  {   |           |  }   |------+------+------+------+------+--------|
 * | LAlt   |   Z  |   X  |   C  |   V  |   B  |  [   |           |  ]   |   N  |   M  |   ,  |   .  |  /   |   L2   |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Lcmd |  F4  |  F5  | Left | Right|                                       | Down |  Up  |  F6  |  F11 |  RAlt  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Prev | Next |       | Vol- | Vol+ |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LCMD,        KC_F4,        KC_F5,   KC_LEFT,KC_RIGHT,
                                                   KC_MPRV,   KC_MNXT,
                                                              KC_MPLY,
        ...
        // right hand
             ...
             KC_RBRC,         KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,          TT(MDIA),
                                                 KC_DOWN,  KC_UP,KC_F6,  KC_F11,KC_RALT,
             KC_VOLD,        KC_VOLU,
             KC_MUTE,
             KC_LSFT,KC_TAB, KC_ENT
    ),
