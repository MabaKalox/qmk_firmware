 ...
 *
 * ,---------------------------------------------------.           ,--------------------------------------------------.
 * | LCMD(F8)|  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |           |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |  PrtSc |
 * |---------+------+------+------+------+------+------|           |------+------+------+------+------+------+--------|
 * |         |   !  |   @  |   {  |   }  |   |  |      |           |      |   Up |   7  |   8  |   9  |   *  |        |
 * |---------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |         |   #  |   $  |   (  |   )  |   `  |------|           |------| Down |   4  |   5  |   6  |   +  |        |
...
[SYMB] = LAYOUT_ergodox(
       // left hand
   LCMD(KC_F8),  KC_F1,KC_F2,  KC_F3  ,  KC_F4,  KC_F5,  KC_F6,
       ...
       _______, KC_AMPR, KC_1,   KC_2,    KC_3,    KC_BSLS, _______,
                         _______,KC_DOT,  KC_0,    KC_EQL,  TG(GAME),
       _______, _______,
       _______,
       _______, _______, _______
),
...
[GAME] = LAYOUT_ergodox(
       ...
       _______, _______, _______, KC_LALT, KC_BSPC,
                                           _______, _______,
                                                    _______,
